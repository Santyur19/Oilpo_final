                ...
                <div class="card">
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-body">
                            ...
                            @csrf
                                ...
                                <div class="mb-3">
                                    <label for="recipient-name" class="col-form-label">Id <small style="color:red;">*</small></label>
                                    <input type="number" name="id_user" class="form-control" id="recipient-name" value="{{old('id_user')}}">
                                    <small class="text-danger">{{$errors->first('rol')}}</small>
                                </div>
                                {{-- <div class="mb-3">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" onclick="agregar_rol()" class="btn btn-success">Agregar
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="{{ route('Roles_editar', $role->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
...
<?php } ?>
    ...
    //         var valor = $(this).val();
    //         alert(valor);
    //         var fila = '<input type="text" value="'+valor+'" name="permiso" >';
    //         $('#input').append(fila);
