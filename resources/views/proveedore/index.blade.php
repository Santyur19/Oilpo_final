...
<div class="row">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('Proveedores_guardar') }}" method="POST" >
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select"  id="" name="Tipo_Doc_proveedor" >
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select"  name="Ciudad_proveedor" >
                                ...
                                @foreach ($proveedores as $proveedore)
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($proveedore->estado=="Activo"){ ?>
                                                @can('editar')
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editar{{$proveedore->id}}" data-bs-whatever="@mdo">Editar
                                            ...
                                            <?php }else{ ?>
                                                @can('editar')
                                                <button disabled type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editar{{$proveedore->id}}" data-bs-whatever="@mdo">Editar
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
                                                    <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"/>
                                                </svg>
                                                </button>
                                    ...
                                    <!-- modal editar -->
                                    <div class="modal fade" id="editar{{$proveedore->id}}" tabindex="-1" aria-labelledby="editar" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="editar">{{ $proveedore->id  }}  Editar Proveedores</h5>
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('editar', $proveedore) }}" method="POST" >
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="message-text" class="col-form-label" >Tipo Documento <small style="color:red;">*</small></label>
                                                            <select class="form-select" id="recipient-name" name="Tipo_Doc_proveedor" required>
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="message-text" class="col-form-label">Nombre <small style="color:red;">*</small></label>
                                                            <input type="text" name="Nombre_proveedor" class="form-control" id="recipient-name" value="{{old('Nombre_proveedor', $proveedore->Nombre_proveedor)}}" required>
                                                            <small class="text-danger">{{$errors->first('Nombre_proveedor')}}</small>

                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="message-text" class="col-form-label">Teléfono <small style="color:red;">*</small></label>
                                                            <input type="number" name="Telefono_proveedor" class="form-control" id="recipient-name" value="{{old('Telefono_proveedor' , $proveedore->Telefono_proveedor)}}" required>
                                                            <small class="text-danger">{{$errors->first('Telefono_proveedor')}}</small>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="message-text" class="col-form-label">Ciudad <small style="color:red;">*</small></label>
                                                            <select require class="form-select" id="recipient-name" name="Ciudad_proveedor" required>
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="message-text" class="col-form-label">Dirección <small style="color:red;">*</small></label>
                                                            <input type="text" name="Direccion_proveedor" class="form-control" id="recipient-name" value="{{old('Direccion_proveedor', $proveedore->Direccion_proveedor)}}" required>
                                                            <small class="text-danger">{{$errors->first('Direccion_proveedor')}}</small>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <a type="button"  class="btn btn-danger" href="javascript:location.reload()">
                                                                Cancelar
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16">
                                                                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                                                    <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
    ...
    <style>
        ...
        .chosen-container-single .chosen-single {
            ...
            padding: 4px 0 0 400px !important;
        }
    </style>
    ...
    <?php } ?>
    {{-- Script para evitar cierre de modal al dar click --}}
    <script>
        $(document).ready(function(){
